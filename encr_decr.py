...
__all__ = ['absoluteEncryption', 'digitalDecryption', 'fileEncryption',
           'md5Encryption', 'normalEncryption']


def absoluteEncryption(value1, print_=False, steps=',', pattern=NULL, signed=True):  # 绝对加密
    """
...
def md5Encryption(string, encr_func=get_md5):
    v_str = list(string)
    a_str = []
...
def normalEncryption(string, mode, key=NULL, key_length=16, details=False, coding=getfilesystemencoding()):
    """ 普通的加密
