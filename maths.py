...
__all__ = [
    'add1', 'average_generator', 'convertSystem', 'is_prime', 'decomposition',
    'divisionAlgorithm', 'euclidean_algorithm', 'get_prime_range',
    'r_to_10_convert', 'saving_decomposition',
]
...
def get_prime_range_of_generator(start=2, end=100, step=1):
