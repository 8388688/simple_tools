...
__all__ = ['binary_search', 'bl_properties', 'bl_properties_of_generator',
...
def bl_properties_of_generator(seqs, line_num=False, truly_number=False, __deep=0, __lines='', __numbers=()):
    """bl 装饰
        ...
        for x in values:
            if type(values[x]) in sequence_class_list:
                ...
                if truly_number:
                    ...
                    cb2 = x
                for t in bl_properties_of_generator(seqs=values[x], line_num=line_num, truly_number=truly_number,
                                                    __deep=__deep + 1,
                                                    __lines=signs + cb,
